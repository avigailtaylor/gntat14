...
# auxiliary perl script called by MATLAB function: edgelist_file_2_ordered_nodelist_and_numeric_edgelist_inc_bg_pr
...
# $ARGV[4] bg_file
# $ARGV[5] bg_edgelist_file (output) (including path)
...
my $background_edgelist_file = $ARGV[5];
open( OUT_bef , ">$background_edgelist_file" ) || ($status_code = -4); 
#*************************************************************
