...
%Version: 1
%Date: 20140722
%Description: Tests if a string ends with '.txt'
%Implementation:
%Keywords:
...
function result = has_txt_extension( filename )

strfind_result = strfind( filename , '.txt' );
result = any( strfind_result == ( length( filename ) - 3 ) );
