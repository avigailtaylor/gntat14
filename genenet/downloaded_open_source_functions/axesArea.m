...
%Version: --
%Date: --
%Description: Set the margin of the axis by specifying a vector of distance to the figure edges.
%Implementation: DOWNLOADED FROM MATLAB CENTRAL
%Keywords: axes area margin
...
%
% Set the margin of the axis by specifying a vector of distance to the figure edges.
%
% Input:
