function [ total_nodes , dir_network , context_network, observed, expected, p_value, seeds_in_network ] =...
    sr_seed( ntwk_edgelist_file , ntwk_header , seed_file , s_header , rands , parallelise , quickview_flag , varargin )

% SYNTAX:
%
% [ total_nodes , dir_network , context_network, observed, expected, p_value, seeds_in_network ] = sr_seed( ntwk_edgelist_file , ntwk_header , seed_file , s_header , rands , parallelise , quickview , varargin )
%
% DESCRIPTION:
%
% Seed connectivity analysis using seed randomisation.
%
% INPUT:
%
...
%
% SEE ALSO: sr_seed_bg sr_seed2back sr_seed2back_bg np_seed np_seed_bg np_seed2back np_seed2back_bg
%
...
sanity_check_standard_inputs( 'sr_seed' , ntwk_edgelist_file , ntwk_header , seed_file , s_header , rands , parallelise , quickview_flag );
