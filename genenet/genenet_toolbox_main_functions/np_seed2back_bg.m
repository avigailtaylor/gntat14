function [ total_nodes , bb_subtotal_of_total_nodes , dir_network , indir_network , context_network , observed , expected , p_values ,...
    seed_bb_in_network , p_values_for_seed_bb , num_edges_to_bb , num_edges_to_bb_exp , seeds_connected_to_bb ,...
    num_seeds_connected_to_bb , num_bb_connected_to_seeds , p_value_to_bb ] =...
    np_seed2back_bg( ntwk_edgelist_file , ntwk_header , bg_file, bg_header , seed_file , s_header , bb_file , bb_header , s_bb_comb , bb_bg_comb , perms , num_switches ,...
    protect_perm_step , parallelise , quickview_flag , varargin )

% SYNTAX:
%
% [ total_nodes , bb_subtotal_of_total_nodes , dir_network , indir_network , context_network , observed , expected , p_values , seed_bb_in_network , p_values_for_seed_bb , num_edges_to_bb , num_edges_to_bb_exp , seeds_connected_to_bb , num_seeds_connected_to_bb , num_bb_connected_to_seeds , p_value_to_bb ] = np_seed2back_bg( ntwk_edgelist_file , ntwk_header , bg_file, bg_header , seed_file , s_header , bb_file , bb_header , s_bb_comb , bb_bg_comb , perms , num_switches , protect_perm_step , parallelise , quickview_flag , varargin )
% 
% DESCRIPTION:
%
% Seed to backbone connectivity analysis using network permutation, and restricting the analysis to a specified sub-network (background) of the primary network.
%
% INPUT:
%
...
%
% SEE ALSO: np_seed np_seed_bg np_seed2back sr_seed sr_seed_bg sr_seed2back sr_seed2back_bg
%
...
sanity_check_standard_inputs( 'np_seed2back_bg' , ntwk_edgelist_file , ntwk_header , bg_file, bg_header , seed_file , s_header , bb_file, bb_header , s_bb_comb , bb_bg_comb , perms , num_switches ,...
    protect_perm_step , parallelise , quickview_flag );
