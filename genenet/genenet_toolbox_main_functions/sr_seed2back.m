function [ total_nodes , bb_subtotal_of_total_nodes , dir_network , context_network , observed , expected , p_value , seed_bb_in_network , num_edges_to_bb , num_edges_to_bb_exp ,...
    ...
    sr_seed2back( ntwk_edgelist_file , ntwk_header , seed_file , s_header , bb_file , bb_header , s_bb_comb , rands , parallelise , quickview_flag , varargin )

% SYNTAX:
%
% [ total_nodes , bb_subtotal_of_total_nodes , dir_network , context_network , observed , expected , p_value , seed_bb_in_network, num_edges_to_bb , num_edges_to_bb_exp , seeds_connected_to_bb , num_seeds_connected_to_bb , num_bb_connected_to_seeds , p_value_to_bb ] = sr_seed2back( ntwk_edgelist_file , ntwk_header , seed_file , s_header , bb_file , bb_header , s_bb_comb , rands , parallelise , quickview_flag , varargin )
%
% DESCRIPTION:
%
% Seed to backbone connectivity analysis using seed randomisation.
%
% INPUT:
%
...
%
% SEE ALSO: sr_seed sr_seed_bg sr_seed2back_bg np_seed np_seed_bg np_seed2back np_seed2back_bg
%
...
sanity_check_standard_inputs( 'sr_seed2back' , ntwk_edgelist_file , ntwk_header , seed_file , s_header , bb_file , bb_header , s_bb_comb , rands , parallelise , quickview_flag );
