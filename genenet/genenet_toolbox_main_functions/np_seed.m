function [ total_nodes , dir_network , indir_network , context_network , observed , expected , p_values , seeds_in_network , p_values_for_seeds ] =...
    np_seed( ntwk_edgelist_file , ntwk_header , seed_file , s_header , perms , num_switches , protect_perm_step , parallelise , quickview_flag , varargin )

% SYNTAX:
%
% [ total_nodes , dir_network , indir_network , context_network , observed , expected , p_values , seeds_in_network , p_values_for_seeds ] = np_seed( ntwk_edgelist_file , ntwk_header , seed_file , s_header , perms , num_switches , protect_perm_step , parallelise , quickview_flag , varargin )
% 
% DESCRIPTION:
%
% Seed connectivity analysis using network permutation.
%
% INPUT:
%
...
%
% SEE ALSO: np_seed_bg np_seed2back np_seed2back_bg sr_seed sr_seed_bg sr_seed2back sr_seed2back_bg
%
...
sanity_check_standard_inputs( 'np_seed' , ntwk_edgelist_file , ntwk_header , seed_file , s_header , perms , num_switches , protect_perm_step , parallelise , quickview_flag );
...
if( gui_handles_available )
    ...
    [ total_nodes , dir_network , indir_network , context_network , observed , expected , p_values , p_values_for_seeds ] =...
        np_seed_aux( numeric_edgelist , ordered_nodelist , numeric_seed_list , seeds_in_network , perms , num_switches ,...
        protect_perm_step , parallelise , quickview_flag , 'gui_handles' , gui_handles );    
else
